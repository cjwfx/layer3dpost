...
const MINIMUM_PRINT_PRICE = 9.95;

const SETUP_CHARGE = 4.50;

/*
  Tuned Stage 2 volume rate.

  £0.15 per cm³.
*/
const VOLUME_RATE_PER_CM3 = 0.15;
...
/* =========================================================
   ...
   - STL and 3MF
   - maximum 256 × 256 × 256 mm
   - dimensions and mesh volume stored in R2
========================================================= */
...
/* =========================================================
   ...
   MUST REMAIN AFTER THE STRIPE WEBHOOK
========================================================= */
...
/* =========================================================
   ...
   The website uses this endpoint to DISPLAY
   the automatic price.

   Geometry is retrieved from private R2
   metadata, so the browser cannot invent
   dimensions, volume or price.
========================================================= */
...
/* =========================================================
   ...
   The final Stripe price is calculated again
   here on the server.

   We do NOT trust a price supplied by the
   customer's browser.
========================================================= */
  ...
  async function (
    ...
    try {
      ...
      for (
        ...
        /*
          Retrieve the trusted geometry from
          R2. This also confirms that the
          uploaded model still exists.
        */
        ...
        /*
          Secure server-authoritative price.
        ...
        */
        ...
        /*
          Store the model reference and
          configuration in Stripe metadata
          for the order webhook/email.
        */
